...
import '../repository/data_firestore.dart';
...
class AuthProvider extends ChangeNotifier {
  ...
  Future<void> register(String name, String email, String password) async {
    try {
      ...
      await dataRepo.saveData(user.user!.uid, email, name, password);
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<void> data(String name, String email, String gpsaddress) async {
    try {
      ...
      await dataRepo.saveData(data.user!.uid, email, gpsaddress, name);
    } catch (e) {
      rethrow;
    }
  }
